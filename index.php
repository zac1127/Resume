...
<html>
  ...
  <head>
    ...
    <!--
      stylesheets
    -->
    <link rel="stylesheet" href="style/normalize.css" media="screen" title="no title">
  ...
  <body>
    ...
    <a name="cover">
      <section class="cover">
        ...
        been married to my wife Danica, and we recently had our first child Emma.
         I am a hard-working, detailed programmer, excited and
  ...
  <a name="skills">
    <section class="skills">
      ...
      <!--  Left section of the skill section-->
      <div class="skill-container">
        <div class="skill-col-1">

          <!-- Circles under the rotating logos  -->
          <div class="circle-5">
            <div class="circle-4">
              <div class="circle-3">
                <div class="circle-2">
                  <div class="circle-1">
                    <span class="cirle_logo"><u>ZB</u></span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="skill-col-2">
          <div class="content-container">
            ...
            <p>
              ...
              With my degree in Computer Science I have gained experience in Java, C, C++, Visual Basic,
              along with strong programming principles such as: data structures, software engineering, and
              algorithm analysis. Being very passionate about both front and back end web development, I have
              gained experience in HTML, CSS, JS, jQuery, PHP, and Laravel. I look forward to hearing from you
              to see how I might can benefit your organization.
            </p>
          </div>
        </div>
      </div>
